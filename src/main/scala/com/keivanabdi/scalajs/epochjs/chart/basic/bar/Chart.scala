...
import com.keivanabdi.scalajs.epochjs.chart.basic.bar.options._
...
class Chart(
    ...
    val orientation:          js.UndefOr[String],
    val padding:              js.UndefOr[Padding],
    val outerPadding:         js.UndefOr[Padding]
...
object Chart {
  ...
  def apply(
      ...
      outerPadding: Option[Padding] = None
  ): Chart = new Chart(
    "bar",
    data.toJSArray,
